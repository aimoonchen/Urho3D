...
namespace bgfx
{
	...
	bx::AllocatorI* g_allocatorEx = &s_allocator;

	struct TinyStlAllocatorEx
	{
		static void* static_allocate(size_t _bytes);
		static void static_deallocate(void* _ptr, size_t /*_bytes*/);
	};

	void* TinyStlAllocatorEx::static_allocate(size_t _bytes)
	{
		return BX_ALLOC(g_allocatorEx, _bytes);
	}

	void TinyStlAllocatorEx::static_deallocate(void* _ptr, size_t /*_bytes*/)
	{
		if (NULL != _ptr)
		{
			BX_FREE(g_allocatorEx, _ptr);
		}
	}
} // namespace bgfx

#define TINYSTL_ALLOCATOR bgfx::TinyStlAllocatorEx
