...
namespace bgfx
{
	...
	class memory_writer : public bx::FileWriter
    {
    public:
        memory_writer();
        ...
        ///
        virtual bool open(const bx::FilePath& _filePath, bool _append, bx::Error* _err) override { return false; }

        ///
        virtual void close() override {}

        ///
        virtual int64_t seek(int64_t _offset = 0, bx::Whence::Enum _whence = bx::Whence::Current) override { return 0; }
