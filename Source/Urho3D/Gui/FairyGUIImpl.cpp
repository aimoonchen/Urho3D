...
namespace Urho3D {
	...
	void FairyGUIImpl::Initialize(Context* context)
	{
		...
		cocos2d::FileUtils::getInstance()->addSearchPath("C:/GitProjects/FairyGUI-cocos2dx/Examples/Resources");
		context->GetSubsystem<ResourceCache>()->AddResourceDir("C:/GitProjects/FairyGUI-cocos2dx/Examples/Resources");
