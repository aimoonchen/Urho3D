...
#       endif
	...
	void CEGuiBaseApplication::OnMouseButtonDown(MouseButton mouseButtons)
	{
	...
	void CEGuiBaseApplication::OnMouseButtonUp(MouseButton mouseButtons)
	{
		CEGUI::MouseButton mb{ CEGUI::MouseButton::Invalid };
		if (mouseButtons == MOUSEB_LEFT) {
			mb = CEGUI::MouseButton::Left;
	...
	void CEGuiBaseApplication::HandleMouseButtonDown(StringHash eventType, VariantMap& eventData)
	{
	...
	void CEGuiBaseApplication::HandleMouseButtonUp(StringHash eventType, VariantMap& eventData)
	{
	...
	void CEGuiBaseApplication::HandleMouseWheel(StringHash eventType, VariantMap& eventData)
	{
...
// 			return;
		...
		injectMouseWheelChange(eventData[P_WHEEL].GetInt());
	}

	void CEGuiBaseApplication::HandleTouchBegin(StringHash eventType, VariantMap& eventData)
	{
// 		auto* input = GetSubsystem<Input>();
// 		if (input->IsMouseGrabbed())
// 			return;
	...
	void CEGuiBaseApplication::HandleTouchEnd(StringHash eventType, VariantMap& eventData)
	{
	...
	void CEGuiBaseApplication::HandleTouchMove(StringHash eventType, VariantMap& eventData)
	{
	...
	void CEGuiBaseApplication::HandleKeyDown(StringHash eventType, VariantMap& eventData)
	{
...
// 			engine_->Exit();
		...
		injectKeyDown(urho3DKeyToCeguiKey(Key(key)));
	}

	void CEGuiBaseApplication::HandleKeyUp(StringHash eventType, VariantMap& eventData)
	{
		using namespace KeyDown;
		int key = eventData[P_KEY].GetInt();

		injectKeyUp(urho3DKeyToCeguiKey(Key(key)));
	}

	void CEGuiBaseApplication::HandleTextInput(Urho3D::StringHash eventType, VariantMap& eventData)
	{
